...
def cargar_datos_desde_sheets():
    """
    Lee los datos de Google Sheets y devuelve:
    - df_respuestas: hoja 'Respuestas de formulario 1'
    - df_cortes: hoja 'Cortes'
    """
    ...
    SPREADSHEET_URL = (
        ...
        "1CK7nphUH9YS2JqSWRhrgamYoQdgJCsn5tERA-WnwXes/edit"
    )
...
def pagina_observacion_clases():
    """
    Renderiza toda la página de 'Observación de clases – Reportes por corte'.
    Esta función es la que llamará app.py.
    """
    ...
    resumen_docente["Clasificación"] = resumen_docente[
        "Total_puntos"
    ].apply(clasificar_por_puntos)
